...
$(function(){
    ...
    $(grid_selector).jqGrid({
        ...
        colModel: [
            ...
            { label: '登录名', name: 'name', width: 200 },
            { label: '真实姓名', name: 'realName', width: 200 },
            { label: '注册时间', name: 'rowAddTime', width: 200 ,hidden:true},
            { label: '操作', name: 'opt', width: 200,formatter: function(cellvalue, options, cell){
        ...
        jsonReader: {//jsonReader来跟服务器端返回的数据做对应
            root: "data.result",   //包含实际数据的数组
            total: "data.totalPageCount", //总页数
            records:"data.totalCount", //查询出的总记录数
